...
response = requests.get("https://pokeapi.co/api/v2/encounter-condition-value?limit=75")
...
with open('encounterConditionsDisplayToAPI.json', 'w') as f:
    json.dump(disAPI, f)

with open('encounterConditionsAPIToDisplay.json', 'w') as f:
    json.dump(APIdis, f)
